...
┌─────────────────────────────────────────────────────────┐
│                      xray.py CLI                        │
│ add / enable / disable / start / stop / restart / ...  │
└────────────────────────┬────────────────────────────────┘
                         │
            ┌────────────┼────────────────┐
            ▼            ▼                ▼
...
```bash
# 创建新实例（打开编辑器编写 YAML 配置，并执行 systemctl enable）
...
# 开机自启 / 取消开机自启
xray.py enable  myserver
xray.py disable myserver
